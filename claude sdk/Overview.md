...
For basic authentication, retrieve an Anthropic API key from the \[Anthropic Console\](https://console.anthropic.com/) and set the \`ANTHROPIC\_API\_KEY\` environment variable.
