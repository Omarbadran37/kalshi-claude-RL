...
\<CodeGroup\>  
  ...
  async def main():  
      async for message in query(  
          prompt="Hello Claude",  
          options={"max\_turns": 1}  
      ):  
          if message.type \== "system" and message.subtype \== "init":  
              print("Available slash commands:", message.slash\_commands)  
              \# Example output: \["/compact", "/clear", "/help"\]
  ...
  async def main():  
      async for message in query(  
          ...
          if (message.type \== "system" and   
              message.subtype \== "compact\_boundary"):  
              print("Compaction completed")  
              print("Pre-compaction tokens:",   
                    message.compact\_metadata.pre\_tokens)  
              print("Trigger:", message.compact\_metadata.trigger)
...
\<CodeGroup\>  
  ...
  for await (const message of query({  
    ...
    if (message.type \=== "system" && message.subtype \=== "init") {  
      ...
      console.log("Session ID:", message.session\_id);  
    }  
  }  
  \`\`\`
  ...
  async def main():  
      ...
      async for message in query(  
          ...
          if message.type \== "system" and message.subtype \== "init":  
              ...
              print("Session ID:", message.session\_id)
...
\<CodeGroup\>  
  ...
  async def main():  
      ...
      async for message in query(  
          ...
          if message.type \== "system" and message.subtype \== "init":  
              \# Will include both built-in and custom commands  
              print("Available commands:", message.slash\_commands)  
              \# Example: \["/compact", "/clear", "/help", "/refactor", "/security-check"\]
